...
We decided we need a couple more packages to work with. As you run these code chunks one by one, you will be prompted to 
answer a question in the terminal, this will ask you to confirm the installation to your `renv` to do this type the letter `y`.
...
If we want to be good about saving these to our default settings then we'll need to take a snapshot of the packages. 
